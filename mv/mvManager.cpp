	...
	if (hashTable->GetHashTableValue("Grid display mode", ivalue)) 
   {
		...
		&& ivalue && m_DataSource->GetVectorArray())
	{
		if (  hashTable->GetHashTableValue("Vector subsample i min",  i1)
			...
			&& hashTable->GetHashTableValue("Vector subsample i rate", i3)
			&& hashTable->GetHashTableValue("Vector subsample j min",  i4)
			&& hashTable->GetHashTableValue("Vector subsample j max",  i5)
			&& hashTable->GetHashTableValue("Vector subsample j rate", i6)
			&& hashTable->GetHashTableValue("Vector subsample k min",  i7)
			&& hashTable->GetHashTableValue("Vector subsample k max",  i8)
