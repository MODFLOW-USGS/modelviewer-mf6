...
CPathlinesClippingPage::CPathlinesClippingPage()
    : CPropertyPage(CPathlinesClippingPage::IDD)
{
...
void CPathlinesClippingPage::Activate(BOOL b)
{
    ...
    BOOL bb =
        ((CButton *)GetDlgItem(IDC_CLIP_BY_TIME_RANGE))->GetCheck() || ((CButton *)GetDlgItem(IDC_CLIP_BY_MINIMUM_TIME))->GetCheck() || ((CButton *)GetDlgItem(IDC_CLIP_BY_MAXIMUM_TIME))->GetCheck();
...
{
    if (((CButton *)GetDlgItem(IDC_CLIP_BY_TIME_RANGE))->GetCheck() || ((CButton *)GetDlgItem(IDC_CLIP_BY_MINIMUM_TIME))->GetCheck() || ((CButton *)GetDlgItem(IDC_CLIP_BY_MAXIMUM_TIME))->GetCheck())
    {
...
{
    BOOL b = ((CButton *)GetDlgItem(IDC_CLIP_BY_TIME_RANGE))->GetCheck() || ((CButton *)GetDlgItem(IDC_CLIP_BY_MINIMUM_TIME))->GetCheck() || ((CButton *)GetDlgItem(IDC_CLIP_BY_MAXIMUM_TIME))->GetCheck();
