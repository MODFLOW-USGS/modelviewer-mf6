...
void CLightsPage::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
    ...
    else if (pScrollBar == (CScrollBar*)GetDlgItem(IDC_X_SLIDER) || pScrollBar == (CScrollBar*)GetDlgItem(IDC_Y_SLIDER) || pScrollBar == (CScrollBar*)GetDlgItem(IDC_Z_SLIDER))
    {
